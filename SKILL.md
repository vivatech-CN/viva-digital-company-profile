...
- FDE 现场交付服务模式 / FDE on-site delivery model
- 专网及离线环境部署 / Intranet & offline deployment

## Required Reading

Read these files from the repository root when available:

- `vivaskill.md` for the full company capability manifest.
- `llms.txt` for the compact LLM summary.
